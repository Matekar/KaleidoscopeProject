...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	controls_sizer->Add( count_sizer, 0, wxEXPAND, 5 );
	...
	controls_sizer->Add( angle_sizer, 0, wxEXPAND, 5 );
	...
	controls_sizer->Add( x_sizer, 0, wxEXPAND, 5 );
	...
	controls_sizer->Add( y_sizer, 0, wxEXPAND, 5 );
